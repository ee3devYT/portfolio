...
function ProfileCard() {
  return (
    <div>
<div className='flex items-center justify-center min-h-screen via-gray-800 to-gray-900 bg-gradient-to-br'>
<div className="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadow-2xl dark:bg-gray-950 dark:border-gray-700 md:max-w-sm rounded-xl">
    <div className="pb-6">
        <div className="flex flex-wrap justify-center">
            <div className="flex justify-center w-full">
                <div className="relative">
                    <img src="https://cdn.discordapp.com/avatars/974986061669355520/0b2b94d135367eadcf82fd63a6ab9c22.png?size=4096" className="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]" />
                </div>
            </div>
        </div>
        <div className="mt-2 mt-20 text-center">
            <h3 className="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">Vedant Mhapsekar</h3>
            <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                <div className="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono text-xl">@ee3dev</div>
            </div>
